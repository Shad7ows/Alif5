...
static inline AlifIntT alifUStr_isSurrogate(AlifUCS4 _ch) { // 16
...
static inline AlifUCS4 alifUStr_highSurrogate(AlifUCS4 ch) { // 35
	return (0xD800 - (0x10000 >> 10) + (ch >> 10));
}

// Low surrogate = bottom 10 bits added to 0xDC00.
// The character must be in the range [U+10000; U+10ffff].
static inline AlifUCS4 alifUStr_lowSurrogate(AlifUCS4 ch) { // 42
